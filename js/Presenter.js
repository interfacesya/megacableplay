...
var Presenter = {
    ...
    {  var self = this,
        ...
        */
        ...
        {
          console.log(event.type +"|"+ template);
            ...
            if (event.type == "select" && template == "template2" && !isNaN(nodo))
            {
               Presenter.cargaDetalle(nodo)
            }
            ...
            if (event.type == "select" && template == "rating")
            {
        ...
        Presenter.jsonRequest({ url: urlFind,
                    ...
                    //console.log(data);
                        ...
                        Presenter.jsonRequest({ url: urlSimilar,
                            ...
                            Presenter.cargaTemplate("template2.xml.js",data,dataSimilar) ;
                        }});
